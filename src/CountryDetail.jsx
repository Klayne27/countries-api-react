  ...
  return (
    <div className="min-h-screen bg-[#f0f0f0] dark:bg-[#202c37] px-4 pt-25 transition-colors">
      <div className="container mx-auto">
        <button
          onClick={() => navigate(-1)}
          className="mt-3 mb-18 md:mb-12 inline-flex items-center px-9 py-2 bg-white dark:bg-[#2b3945] text-black dark:text-white rounded-md shadow-md hover:opacity-80 transition-colors cursor-pointer"
        >
          &larr; Back
        </button>

        <div className="flex flex-col md:flex-row items-center gap-15 md:gap-40 text-black dark:text-white transition-colors">
